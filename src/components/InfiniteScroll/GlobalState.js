// https://github.com/baobabKoodaa/blog/blob/master/src/components/GlobalState/GlobalState.js
...
export class GlobalState extends React.Component {
        ...
        fetch(`${__PATH_PREFIX__}/paginationJson/index${this.state.cursor}.json`)
            ...
            .then(
              res => {
                ...
                // console.log(res)
                // console.log(`${__PATH_PREFIX__}/paginationJson/index${this.state.cursor}.json`)
            },
            error => {
                this.setState({
                    isLoading: false,
    ...
    hasMore = (numPages) => {
        return this.state.cursor <= numPages && this.state.useInfiniteScroll
    }
